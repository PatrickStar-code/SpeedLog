<section class="container mx-auto px-6 p-10">
    ...
    <div class="flex items-center flex-wrap mb-20 ">
        <div class="w-full md:w-1/2">
            <h4 class="text-3xl text-gray-800 font-bold mb-3 dark:text-white">RÁPIDO ATENDIMENTO</h4>
            <p class="text-gray-600 mb-8 dark:text-white">Nossos motoboys sempre estão a toda velocidade para a entrega chegar ao seu domicilio rapido e segura!</p>
        </div>
        <div class="w-full md:w-1/2">
            <img src="<?php echo base_url("assets/IMGS/rapido_atendimento.png") ?>" alt="Monitoring" class="object-contain w-96 h-96" />
        </div>
    </div>

    <div class="flex items-center flex-wrap mb-20">
        <div class="w-full md:w-1/2 max-sm:hidden">
            <img src="<?php echo base_url("assets/IMGS/privacidade.png") ?>" alt="Monitoring" class="object-contain lg:ml-56 w-96 h-96" />
        </div>
