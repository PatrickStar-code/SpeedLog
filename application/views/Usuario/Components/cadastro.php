    ...
    <div class="md:w-1/2 max-w-lg mx-auto my-24 px-4 py-5 shadow-none">
        ...
        <form method="post" id="registro" class="p-0">
            ...
            <div class="grid grid-cols-2 mt-5">
                ...
                <div>
                    <input type="password" name="r_senha" id="r_senha" class="dark:text-white block w-full p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent  " placeholder="Repita a Senha">
                </div>
            </div>
