    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName"
                class="flex  items-center dark:text-white text-sm font-2xl text-black font-bold rounded-full hover:text-black-600 md:mr-0 "
                type="button">
                <span class="sr-only">Open user menu</span>
                <img class="w-8 h-8 mr-2 rounded-full"
                    src="<?php echo base_url("assets/IMGS/bd/" . $_SESSION["login_cliente"]["foto_usuario"]) ?>"
                    alt="user photo">
            ...
            <div id="dropdownAvatarName"
                ...
                <div class="px-4 py-3 text-sm text-black">
                    <div class="truncate font-2xl dark:text-white">
                        <?php echo "Cliente #" . $_SESSION['login_cliente']["idUsuario"] ?>
                    </div>
                    <div class="truncate font-2xl dark:text-white">
                        <?php echo $_SESSION['login_cliente']["email_usuario"] ?></div>
                </div>
                <ul class="py-2 text-sm text-blcak" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                    <li>
                        <a href="#"
                            class="block px-4 py-2 hover:bg-gray-300 font-2xl  hover:text-black dark:hover:bg-gray-600 dark:hover:text-white">Perfil</a>
                    </li>
                    <li>
                        <a data-modal-toggle="nova_encomenda"
                            class="block px-4 py-2 hover:bg-gray-300 font-2xl  hover:text-black dark:hover:bg-gray-600 dark:hover:text-white">Enviar
                            Encomenda</a>
                    </li>

                </ul>
                <div class="py-2">
                    <a href="<?php echo site_url("user/deslogar") ?>"
                        class="block px-4 py-2 text-sm text-black font-2xl  hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Deslogar</a>
                </div>
            </div>

            <!-- Main modal -->
            <div id="nova_encomenda" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div
                            ...
                            <button type="button"
                                ...
                                data-modal-toggle="nova_encomenda">
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="desc" id="desc"
                                        ...
                                        placeholder="Digite o peso da entrega" required>
                                </div>
                                <div>
                                    <label for="peso"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="complemento" id="complemento"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Objeto Fragil">
                                </div>

                                <div>
                                    <label for="origem"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CEP local
                                        de origem da entrega</label>
                                    <input type="text" name="origem" id="origem"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="48958-561" required="">
                                    <small class="text-red-500" id="erro_origem"></small>
                                </div>
                                <div>
                                    <label for="origem_n"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Número do
                                        local de origem</label>
                                    <input type="text" name="origem_N" id="origem_n"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="102" required="">
                                </div>
                                <div>
                                    <label for="bairro_origem"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bairro
                                        Origem</label>
                                    <input type="text" name="bairro_origem" id="bairro_origem"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="" disabled>
                                </div>
                                <div>
                                    <label for="log_origem"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Logradouro
                                        Origem</label>
                                    <input type="text" name="log_origem" id="log_origem"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="" disabled>
                                </div>
                                ...
                                <div>
                                    <label for="destino_n"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero do
                                        local de destino da entrega</label>
                                    <input type="text" name="destino_n" id="destino_n"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div>
                                    <label for="bairro_destino"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bairro
                                        Destino</label>
                                    <input type="text" name="bairro_destino" id="bairro_destino"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="" disabled>
                                </div>
                                <div>
                                    <label for="log_destino"
                                        class="block mb-2 text-sm font-medium text-black dark:text-white">Logradouro
                                        Destino</label>
                                    <input type="text" name="log_destino" id="log_destino"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="" disabled>
                                </div>
                                <div>
                                    <label for="valor_total"
                                        class="block mb-2 text-sm font-medium text-black dark:text-white">Valor
                                        Estimado</label>
                                ...
                                <input type="text" id="cod"
                                    value="<?php echo $_SESSION["login_cliente"]["idUsuario"] ?>" class="hidden">

                                <input type="text" id="distancia" class="hidden">
                                <input type="text" id="tempo_estimado" class="hidden">
                                <input type="text" name="localidade_origem" id="localidade_origem" class="hidden"
                                    required="" disabled>
                                ...
                                <input type="text" name="uf_destino" id="uf_destino" class=" hidden" required=""
                                    disabled>
                                <input type="text" name="localidade_destino" id="localidade_destino" class="hidden"
                                    required="" disabled>


                            </div>
                            <span id="alerta"></span>
                            <button type="button" id="gerar_valor"
                                class="text-white inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                <img src="<?php echo base_url("assets/IMGS/entrega-rapida.png") ?>"
                                    class="mr-1 -ml-1 w-6 h-6" alt="">
                            ...
                            <div id="ConfirmModal" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    ...
                                    <div
                                        ...
                                        <img src="<?php echo base_url("assets/IMGS/interroga.png") ?>" alt=""
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            ...
                                            <button type="submit"
                                                class="py-2 px-3 text-sm font-medium text-center text-white bg-[#00968f] rounded-lg hover:bg-[#002D2B] focus:ring-4 focus:outline-none focus:ring-[#00968f] ">
            ...
            <a data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                class="text-white bg-[#00968f] hover:bg-[#002D2B] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Logar</a>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-6" method="post" id="logar">
                                ...
                                <button
                                    class="block w-full rounded-lg bg-[#00968f] hover:bg-[#002D2B] px-5 py-3 text-sm font-medium text-white"
                                    type="subm">Acessar</button>
                                <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                    Não possue conta? <a href="<?php echo site_url("User/cadastro") ?>"
                                        class="text-blue-700 hover:underline dark:text-blue-500">Crie uma aqui!</a>
                                </div>
                            </form>
                            <span id="alert"></span>
        ...
        <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                    <a href="#"
                        class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Company</a>
                </li>
                <li>
                    <a href="#"
                ...
                <li>
                    <a href="#"
                        class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Features</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Team</a>
                </li>
                <li>
                    <a href="#"
...
$(document).ready(function() {
        ...
        $("#gerar_valor").click(function(e) {
            e.preventDefault();
            // if () {
            //     const $targetEl = document.getElementById('ConfirmModal');
