        ...
        <?php foreach ($encomendas as $key => $encomenda){ ?>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="<?php echo base_url("assets/bd/".$encomenda->foto_motoboy) ?>" alt="Entregador Img">
                    <div>
                ...
                <td class="px-6 py-4">
                <?php echo $encomenda->hora_inicio_transporte?>
                </td>
                <td class="px-6 py-4">
                <?php echo $encomenda->hora_previsto_tranporte ?>
                </td>
                <?php }else{ ?>
                    <td class="px-6 py-4">
