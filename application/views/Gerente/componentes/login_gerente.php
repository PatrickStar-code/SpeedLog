...
<div class="grid h-screen place-items-center mx-auto max-h-screen-sm max-w-screen-xl px-5 xl:py-16 sm:px-5 py-5 md:px-8 md:py-4"><div>
    <h1 class="text-center text-2xl font-bold text-gray-100 sm:text-3xl">Área do Gerente</h1>
    ...
    <form action="" id="logar" class="mt-6 mb-0 space-y-4  bg-gray-100 rounded-tl-lg rounded-tr-lg p-8 shadow-2xl">
        ...
        <div>
            <label for="email_logar" class="text-sm font-medium">Login</label>
            <div class="relative mt-1">
                <input type="text" name="email_logar" id="email_logar"
                    class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="" />
        ...
        <div>
            ...
            <div class="relative mt-1">
                <input type="password" name="senha_logar_gerente" id="senha_logar_gerente" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="" />
                <span class="absolute inset-y-0 right-4 inline-flex items-center">
        ...
        <button type="submit" class="block w-full rounded-lg bg-[#00968f] px-5 py-3 text-sm font-medium text-white">Login</button>
    </form>
