<section class="min-h-screen flex items-stretch text-white ">
    <div class="lg:flex w-screen hidden bg-gray-500 bg-no-repeat bg-center bg-cover relative items-center" id="img" style="background-image: url(<?php echo  base_url("assets/IMGS/Home.png") ?>);">
        <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
        <div class="w-full px-24 z-10">
            <h1 id="desc" class="text-5xl font-bold text-left tracking-wide"></h1>
            <p class="text-3xl my-4" id="texto"></p>
        </div>
