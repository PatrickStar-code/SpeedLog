...
<div class="grid h-screen place-items-center mx-auto max-h-screen-sm max-w-screen-xl px-5 xl:py-16 sm:px-5 py-5 md:px-8 md:py-4">
    <div class="">
        ...
        <form action="" id="logar" class="mt-6 mb-0 space-y-4  bg-gray-100 rounded-tl-lg rounded-tr-lg p-8 shadow-2xl">
            ...
            <div>
                <label for="email_logar" class="text-sm font-medium">E-mail</label>
                <div class="relative mt-1">
                    <input type="text" id="email_logar" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="" />
            ...
            <div>
                ...
                <div class="relative mt-1">
                    <input type="password" id="senha_logar" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="" />
            ...
            <p class="text-center text-sm text-gray-500">
                ...
                <button type="button" data-modal-toggle="defaultModal" class="underline">Cadastrar-se</button>
            </p>
        </form>
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <ol class="flex items-center w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 sm:text-base dark:bg-gray-800 dark:border-gray-700 sm:p-4 sm:space-x-4">
                    <li id="etapa1" class="flex items-center text-[#00fff4] dark:text-[#00fff4]">
                        <span class="flex items-center justify-center w-5 h-5 mr-2 text-xs border  rounded-full shrink-0 dark:border-blue-500">
                            1
                        </span>
                ...
                <form method="post" id="registro">
                    ...
                    <div id="reg_2" class="p-0">
                        ...
                        <div class="grid grid-cols-2 mt-5">
                            <div class="relative z-0 mr-3">
                                <input type="text" name="placa" id="placa" class="block py-2.5 px-0 block w-full p-2 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#00fff4] focus:outline-none focus:ring-0 focus:border-[#00968f] peer" placeholder=" " />
