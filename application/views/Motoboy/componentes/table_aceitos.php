        ...
        <tbody>
            <?php foreach ($retorno as $key => $encomenda) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($encomenda->status_entrega == "Em Transporte"){ ?>
                            <button class="confirmar_pedido text-white bg-[#00968f] hover:bg-emerald-700  font-medium rounded-lg text-sm px-4 py-2.5 mr-2 dark:bg-[#00968f] dark:hover:bg-[#002D2B] focus:outline-none dark:focus:ring-blue-800" type="button" id="<?php echo $encomenda->idEntregas ?>"><i class="fa-solid fa-clipboard-check"></i></button>
                        ...
                        <?php }else{ ?>
                            <button class="cancelar_pedido text-white bg-red-600 hover:text-red-800  font-medium rounded-lg text-sm px-4 py-2.5 mr-2 dark:bg-[#00968f] dark:hover:bg-[#002D2B] focus:outline-none dark:focus:ring-blue-800" type="button" id="cancelar-<?php echo $encomenda->idEntregas ?>"><i class="fa-solid fa-x "></i></button>
                            <button class="iniciar_pedido text-white bg-[#002d2b] hover:text-[#00fff4]  font-medium rounded-lg text-sm px-4 py-2.5 mr-2 dark:bg-[#00968f] dark:hover:bg-[#002D2B] focus:outline-none dark:focus:ring-blue-800" type="button" id="iniciar-<?php echo $encomenda->idEntregas ?>"><i class="fa-solid fa-motorcycle"></i></button>
                        <?php } ?>
                    </td>
